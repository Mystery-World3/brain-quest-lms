  ...
  useEffect(() => {
    ...
    const loadQuizAndLeaderboard = async () => {
      try {
        ...
        // Pasang listener leaderboard real-time dari database pusat
        const unsubscribe = listenToLeaderboard(parsed.quizId, parsed.classId, (scores) => {
          const mappedScores = scores.map((s: any) => ({
            ...s,
            isCurrent: s.name === name && s.score === parsed.score // Identifikasi sederhana
          }));
      ...
      <div className="w-full max-w-4xl space-y-10 pb-40">
        <div className={cn(
          ...
          <div className="relative z-10 flex flex-col items-center">
            ...
            <div className="relative group">
              ...
              <div className="relative inline-flex flex-col items-center justify-center bg-white text-primary rounded-full w-44 h-44 md:w-56 md:h-56 shadow-[0_15px_60px_-15px_rgba(255,255,255,0.5)] border-[10px] md:border-[15px] border-primary/10">
        ...
        <div className="flex justify-center px-4">
           <Card 
            ...
            className="w-full max-w-md p-6 md:p-8 flex flex-row items-center gap-4 md:gap-6 border-4 rounded-[2rem] md:rounded-[2.5rem] hover:bg-accent/5 transition-all cursor-pointer group shadow-xl border-accent/10"
           >
                    ...
                    <div className="flex flex-col md:flex-row gap-6 md:gap-8">
                      ...
                      <div className="flex-1 space-y-4 md:space-y-6">
                        <div className="flex flex-col sm:flex-row justify-between items-start gap-4">
                          ...
                          {isCorrect ? (
                            <Badge className="bg-green-100 text-green-700 dark:bg-green-900/50 dark:text-green-300 border-none shrink-0 py-2 px-4 rounded-xl font-black text-xs tracking-widest">
                              <CheckCircle2 size={16} className="mr-2" /> BENAR
                            </Badge>
                          ) : (
                            <Badge className="bg-red-100 text-red-700 dark:bg-red-900/50 dark:text-red-300 border-none shrink-0 py-2 px-4 rounded-xl font-black text-xs tracking-widest">
